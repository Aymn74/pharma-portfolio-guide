...
دليل لحديثي التخرج في الصيدلة، وللصيادلة الذين يريدون إثبات كفاءتهم عند التقدم لوظيفة أو داخل جهة عملهم. لا يفترض الدليل أنك تعرف البرمجة. كل ما تحتاجه أن تفهم مشكلة مهنية في مجالك، وأن تقود أداة ذكاء اصطناعي لتبني الحل، ثم أن تشرح ما بُني وتدافع عنه.

الجزء الأول من الدليل بالعربية ويشرح الفكرة والمصطلحات وطريقة العمل. الجزء الثاني يحوي «العقد العام» وأربعين مواصفة مشروع بالإنجليزية، لأنها تُعطى مباشرة إلى أداة الذكاء الاصطناعي التي تعمل بالإنجليزية أفضل. لكل مشروع شرح عربي مبسط قبل النص الإنجليزي.
...
النسخة المطبوعة من هذا الدليل: [docs/PHARMA_PORTFOLIO_GUIDE.pdf](./docs/PHARMA_PORTFOLIO_GUIDE.pdf)
...
البرومبت الذي تعطيه للوكيل = النص الموجود في «العقد العام» أدناه كاملًا + مواصفة المشروع الذي اخترته. انسخهما معًا في رسالة واحدة. لا تحذف قسم القيود
(Limits)
من أي مواصفة؛ هو جزء من قوة المشروع المهنية.
