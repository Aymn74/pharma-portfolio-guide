...
**الفكرة ببساطة:** تسوية الأدوية عند انتقال المريض بين مستويات الرعاية مهمة صيدلانية أساسية. هذا المشروع يبني قائمة الأدوية النشطة من سجلات مصطنعة ويكشف التعارضات المحتملة (تكرار مادة، جرعة ناقصة، أمر قديم). مناسب للصيدلة السريرية.
...
**الفكرة ببساطة:** الأثر الميزاني يسأل: كم سيكلف إدخال دواء جديد جهة دافعة خلال سنوات قليلة؟ هذا المشروع يبني صندوق سيناريوهات لسياق سعودي بمدخلات موسومة (حقيقية من القوائم العامة أو مصطنعة). مناسب للاقتصاد الصحي والتأمين.
...
**الفكرة ببساطة:** الدواء الواحد يُكتب بعشر طرق: اسم تجاري، اسم علمي، ملح مختلف، خطأ إملائي، اسم عربي منقول. هذا المشروع يبني خدمة صغيرة تحل أي اسم إلى هوية معيارية بدرجة ثقة وبدائل، ولا تطابق صامتًا عند الشك. مناسب لمسار البيانات والتكامل، ويحتاج قدرة برمجية.
