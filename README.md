...
بنية الأعمال تتغير سريعًا مع دخول الذكاء الاصطناعي، ويتغير معها ما يُقنع مدير التوظيف. عبارة «أجيد تحليل البيانات» في سيرتك لا يمكن التحقق منها، والشهادة تثبت حضورًا لا قدرة.

المشروع يثبت القدرة: عمل منشور باسمك ببيانات رسمية ومنهج معلن، يُفتح ويُفحص في دقيقتين، وتشرح فيه قراراتك وحدوده.

## 2. ما الذي يتم بناؤه بشكل محدد؟

كل مشروع في هذا الدليل أداة صغيرة تعمل على بيانات عامة رسمية (قوائم الأدوية المسجلة، بلاغات الأعراض الجانبية، سجلات التجارب السريرية)، تجيب عن سؤال مهني واحد محدد، تعرض الإجابة بوضوح، وتقول صراحة ما الذي لا تستطيع إثباته.
