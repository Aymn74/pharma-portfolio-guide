# من الصيدلة إلى محفظة أعمال قابلة للإثبات

## أربعون مشروعًا مهنيًا للصيادلة، تُبنى بمساعدة وكلاء الذكاء الاصطناعي، بمصادر بيانات مثبتة
...
لا يفترض الدليل معرفة مسبقة بالبرمجة. كل ما يحتاجه المتدرب والراغب في التجربة هو فهم مشكلة مهنية في مجال معين، لقيادة أداة ذكاء اصطناعي للمساعدة في تبني الحل، ثم شرح ما تم بناؤه.

الجزء الأول من الدليل بالعربية ويشرح الفكرة والمصطلحات وطريقة العمل. الجزء الثاني يحوي «العقد العام» وأربعين مواصفة مشروع بالإنجليزية، لأنها تُعطى مباشرة إلى أداة الذكاء الاصطناعي. لكل مشروع شرح عربي مبسط قبل النص الإنجليزي.
...
النسخة المطبوعة من هذا الدليل: [docs/PHARMA_PORTFOLIO_GUIDE.pdf](https://github.com/Aymn74/pharma-portfolio-guide/blob/main/docs/PHARMA_PORTFOLIO_GUIDE.pdf)

---

# الجزء الأول: الفكرة بلغة بسيطة

## 1. لماذا مشروع، وليس شهادة أخرى؟

السيرة الذاتية تقول عادة: «أجيد تحليل البيانات، وأفهم الشؤون التنظيمية أو التأمين أو اليقظة الدوائية». هذه عبارة لا يستطيع مدير التوظيف التحقق منها. المشروع يحولها إلى دليل يمكن فتحه وفحصه في دقيقتين: بيانات رسمية حقيقية، تحليل يحترم قواعد المجال ولا يبالغ، وواجهة أو تقرير يفهمه غير المختص، وصاحب مشروع يستطيع شرح ثلاثة قرارات اتخذها، وخطأ اكتشفه، وقيد لم يحله.

المشروع لا يقوي السيرة لأنه «يستخدم الذكاء الاصطناعي»، بل لأنه يثبت أن صاحبه استطاع تحويل مشكلة صيدلانية إلى منتج يمكن تدقيقه.

## 2. ما الذي ستبنيه بالضبط؟

كل مشروع في هذا الدليل هو أداة صغيرة تعمل على بيانات عامة رسمية (مثل قوائم الأدوية المسجلة، أو بلاغات الأعراض الجانبية، أو سجلات التجارب السريرية)، وتجيب عن سؤال مهني واحد محدد، وتعرض الإجابة بطريقة واضحة، وتقول صراحة ما الذي لا تستطيع إثباته.

مثال: بدل أن تكتب في سيرتك «خبرة في نقص الأدوية»، تبني أداة تجمع قوائم النقص المنشورة رسميًا في أمريكا وأوروبا والسعودية، وتُظهر أي المواد الفعالة تظهر في أكثر من قائمة، وتحدّث نفسها أسبوعيًا، وتقول بوضوح: «هذا تقاطع وصفي، وليس توقعًا لنقص محلي».

## 3. المصطلحات التي ستقابلها

كل مصطلح أدناه مكتوب بالإنجليزية في سطر مستقل، ثم شرحه بالعربية.

GitHub
موقع يُحفظ فيه الكود والملفات مع تاريخ كامل لكل تغيير. المستودع
(repository)
هو مجلد المشروع على هذا الموقع. مدير التوظيف يستطيع فتحه وقراءة كل شيء. المستودع هو الدليل الأساسي على عملك.
...
خدمة مشابهة داخل
GitHub
لنشر صفحات وتقارير ثابتة. مناسبة للمشاريع الإحصائية التي ناتجها تقرير لا تطبيق.

AI coding agent
أداة ذكاء اصطناعي تكتب الكود وتشغّله وتختبره وتصلح أخطاءه بنفسها داخل مجلد المشروع، مثل
Claude Code
و
Codex
و
Gemini CLI.
أنت تعطيها التعليمات وتراجع النتيجة؛ هي تنفذ.

Prompt
نص التعليمات الذي تعطيه للوكيل. في هذا الدليل، البرومبت الكامل لأي مشروع = «العقد العام» + «مواصفة المشروع». تنسخ النصين معًا وتعطيهما للوكيل.

Data source
الجهة الرسمية التي تأتي منها البيانات، مثل هيئة الغذاء والدواء أو منظمة الصحة العالمية. كل مشروع هنا يعتمد على مصدر جُرّب فعليًا.

API
باب إلكتروني تفتحه الجهة ليأخذ منه البرنامج البيانات مباشرة بدل تنزيل ملف يدويًا. بعض الجهات توفره وبعضها يوفر ملفات فقط.

Snapshot
نسخة من البيانات مؤرخة بتاريخ أخذها. البيانات الحكومية تتغير، لذلك المشروع الجيد يقول دائمًا «هذه النتائج من نسخة تاريخ كذا».

Checksum
بصمة رقمية للملف تثبت أنه لم يتغير. المشروع يسجلها ليثبت أي نسخة من الملف استُخدمت.

Source doctor
أمر داخل المشروع يفحص آليًا: هل رابط المصدر يعمل؟ هل الملف بالشكل المتوقع؟ هل الأعمدة موجودة؟ إذا تغير شيء، يتوقف المشروع برسالة واضحة بدل أن ينتج أرقامًا خاطئة بصمت.

Fixture
عينة صغيرة ثابتة من البيانات (مثلًا 50 صفًا) تُحفظ داخل المشروع ليعمل الاختبار دون إنترنت ودون رفع الملف الحكومي الكامل.

Synthetic data
بيانات مصطنعة تشبه الحقيقية في الشكل لكنها ليست عن أشخاص حقيقيين. تُستخدم كلما احتاج المشروع «مرضى» أو «مطالبات» أو «مخزونًا»، ويجب أن تُوسم بوضوح أنها مصطنعة.

Tests
فحوصات آلية تتأكد أن الحسابات صحيحة وأن المشروع يفشل بوضوح عند تغير البيانات. وجودها أهم دليل على الجدية.

Review queue
قائمة الحالات التي لم تستطع الأداة الحكم عليها آليًا فتركتها لمراجعة الإنسان. الأداة الصادقة لا تدّعي أنها حسمت كل شيء.

Gold set
عينة صغيرة راجعها إنسان بعناية وتُستخدم لقياس دقة الأداة. بدلًا من قول «الأداة دقيقة»، تقول «الأداة أصابت 46 من 50 حالة راجعتها يدويًا».

README
أول ملف يقرؤه أي زائر للمستودع. يشرح المشروع والمصدر والطريقة والقيود وكيفية التشغيل.
...
أين يفشل الاستخدام السطحي للوكيل؟ حين يبدأ بالواجهة قبل فتح المصدر، أو يخترع عمودًا لأن اسمه يبدو منطقيًا، أو يحسب مؤشر بلاغات ويسميه «احتمال حدوث العرض»، أو يجمع سعرين لعبوتين مختلفتين ويسمي الفرق توفيرًا، أو يملأ الفراغات بصفر كي يبدو الرسم أجمل. «العقد العام» في الجزء الثاني يمنع هذه الأخطاء صراحة.
...
5. انسخ «العقد العام» كاملًا، ثم انسخ تحته مواصفة المشروع، وأعطهما للوكيل كرسالة واحدة. إن كنت غير مبرمج، أضف في أول سطر:
...
| 23 | تسوية الأدوية على بيانات مصطنعة | عالمي | صيدلة سريرية | M | ◐ |
...
لا تبنِ الأربعين. أفضل محفظة ثلاثة مشاريع: مشروع أساسي عميق في المسار الذي تستهدفه، ومشروع مجاور يثبت اتساع فهمك، ومشروع صغير مصقول يثبت أنك تُكمل وتنشر.
...
قاعدة الاختيار: قيّم نفسك من 1 إلى 5 في معرفة المجال والإحصاء والبرمجة والوقت والقدرة على الشرح، ثم اختر مشروعًا أعلى منك بدرجة واحدة فقط. لا تبدأ بمشروع فئة
L
إذا لم تستطع شرح المقام الإحصائي فيه.
...
## 9. كيف تكتبه في سيرتك وتعرضه في مقابلة؟
...
لا تكتب هذا السطر قبل أن تظهر الأرقام الفعلية من تشغيل مشروعك أنت.

عرض المقابلة في خمس دقائق: 30 ثانية للمشكلة، 45 ثانية لإثبات المصدر (افتح تقرير الفحص وأظهر الملف والتاريخ)، 90 ثانية لعرض مسار واحد في الأداة، 60 ثانية لأصعب قرار اتخذته، 45 ثانية لاختبار فشل فكشف خطأ، 30 ثانية لما لا يثبته المشروع، و30 ثانية للخطوة التالية.
...
# الجزء الثاني: العقد العام ومواصفات المشاريع (بالإنجليزية)
...
2. **مواصفة المشروع:** الصندوق الإنجليزي الخاص بالمشروع الذي اخترته من القائمة.

الترتيب: العقد أولًا، ثم المواصفة تحته، ثم أرسل الرسالة.

مثال: اخترت المشروع 38؟ الرسالة = نص العقد العام، يليه نص صندوق
PROJECT 38.

ولا تحذف من المواصفة قسمَي
METHOD AND LIMITS
و
ACCEPTANCE TESTS.
قد يبدو أنهما يقيّدان المشروع ويصغّرانه، لكنهما ما يجعله مقنعًا أمام مدير التوظيف، لأنهما يمنعان الأداة من ادعاء ما لا تثبته البيانات.
...
كل مواصفة تبدأ بشرح عربي مبسط (الفكرة، ولمن تناسب، وما الذي لا تدّعيه)، ثم نص المواصفة بالإنجليزية داخل صندوق. انسخ محتوى الصندوق بعد العقد العام.

---

### 1 — Saudi Drug Registry Quality Explorer

**الفكرة ببساطة:** قائمة الأدوية البشرية المسجلة في السعودية ملف عام كبير. هذا المشروع يفحص جودة هذا الملف نفسه: أي الحقول ناقصة، أين التكرارات، وكيف تغيرت القائمة بين نسختين. مناسب لمن يستهدف الشؤون التنظيمية أو تحليل البيانات. لا يدّعي أن القائمة المنشورة هي حالة التسجيل اللحظية.
...
**الفكرة ببساطة:** الجهات السعودية تسمي الدواء نفسه بصيغ مختلفة: قائمة التسجيل تقول شيئًا، وكتالوج الشراء الموحد يقول شيئًا آخر. هذا المشروع يقترح مطابقات بين السجلين بدرجة ثقة، ويترك القرار النهائي للإنسان. مناسب لوصول السوق والإمداد والتكامل. المطابقة ليست تكافؤًا علاجيًا ولا تعاقديًا.
...
**الفكرة ببساطة:** كتالوج الشراء الموحد يتغير مع كل إصدار: أصناف تُضاف وتُحذف، ورموز تتبدل. هذا المشروع يراقب هذه التغيرات ويعرضها بوضوح على خط زمني. مناسب لسلاسل الإمداد. لا يدّعي معرفة المخزون أو الأسعار.
...
**الفكرة ببساطة:** الشراء الموحد ينشر قائمة المنافسات وخطتها ونتائجها علنًا. هذا المشروع يجمع البيانات الوصفية العامة فقط (الرقم، العنوان، الحالة، التواريخ) ويعرضها كتقويم وخط زمني. مناسب للمشتريات. لا يشتري كراسات، ولا يتوقع الفوز أو الأسعار.
...
**الفكرة ببساطة:** حين تُنشر قائمة نقص أو تعميم سحب، ماذا يحدث لمخزون افتراضي ومرضى افتراضيين؟ هذا المشروع يحاكي الأثر التشغيلي على بيانات مصطنعة بالكامل. مناسب للسلامة والإمداد في المستشفيات. ليس أداة تنبؤ بنقص حقيقي ولا يقترح بدائل علاجية.
...
**الفكرة ببساطة:** منصة التأمين الإلكترونية السعودية تنشر دليل تطبيق عامًا يحدد شكل المطالبة الإلكترونية. هذا المشروع يبني مختبرًا محليًا يفحص أمثلة مصطنعة من المطالبات ضد هذا الدليل ويشرح الأخطاء بلغة يفهمها الصيدلي. مناسب للتأمين والمعلوماتية الصحية. ليس اتصالًا حيًا ولا شهادة اعتماد.
...
**الفكرة ببساطة:** مجلس الضمان الصحي يحدد الحد الأدنى من البيانات التي يجب أن ترافق كل مطالبة أو زيارة. هذا المشروع يحول هذه المتطلبات إلى قواعد فحص تعمل على بيانات مصطنعة ويعرض أثر الأخطاء على قابلية التحليل. مناسب لجودة البيانات في التأمين. لا يدّعي أنه نسخة تشغيلية كاملة من المتطلبات.
...
**الفكرة ببساطة:** سجل التجارب السريرية الأمريكي يوفر واجهة عامة تُظهر كل التجارب المسجلة ومواقعها. هذا المشروع يرسم خريطة للتجارب في دول الخليج وشرق المتوسط: عددها وحالتها ومرحلتها ورعاتها، مع صفحة خاصة بالسعودية. مناسب للأبحاث السريرية. عدد التجارب ليس مقياسًا لجودة البحث.
...
**الفكرة ببساطة:** منظمة الصحة العالمية تنشر مؤشرات استهلاك المضادات الحيوية حسب تصنيفها الثلاثي للدول. هذا المشروع يعرض هذه المؤشرات لدول الإقليم مع إبراز الفجوات بدل ملئها. مناسب للصحة العامة وترشيد المضادات. الاستهلاك ليس مقاومة ولا ملاءمة وصف.
...
**الفكرة ببساطة:** إدارة الغذاء والدواء الأمريكية تنشر بيانات كل الطلبات والمنتجات والموافقات. هذا المشروع يبني مستكشفًا لتاريخ الموافقات يوضح العلاقة بين الطلب والمنتج والمادة الفعالة. مناسب للشؤون التنظيمية العالمية. تاريخ الموافقة ليس تاريخ الطرح في السوق.
...
**الفكرة ببساطة:** «الكتاب البرتقالي» الأمريكي يسجل المنتجات المرجعية والتكافؤ العلاجي والبراءات وفترات الحصرية. هذا المشروع يشرح البنية التنافسية لكل مادة وأحداث دخول الجنيس المحتملة كإشارات تنظيمية. مناسب لمسار الجنيس والملكية الفكرية. ليس مشورة براءات ولا تنبؤًا بدخول السوق.
...
**الفكرة ببساطة:** «الكتاب الأرجواني» يسجل المنتجات البيولوجية والبدائل الحيوية وحالة قابلية التبادل. هذا المشروع يعرض العلاقات بين المنتج المرجعي وبدائله وتواريخها. مناسب لمسار البيولوجيات. البديل الحيوي ليس جنيسًا، والترخيص لا يعني قابلية التبادل.
...
**الفكرة ببساطة:** نشرات الأدوية الأمريكية تُحدّث باستمرار، والفرق بين نسختين قد يحمل تحذيرًا جديدًا. هذا المشروع يقارن نسختين من نشرة منتج واحد ويُظهر ما تغير في الأقسام المهمة مع الرجوع إلى النص الأصلي. مناسب للمعلومات الدوائية. لا يقدم توصية علاجية.
...
**الفكرة ببساطة:** قاعدة بلاغات الأعراض الجانبية الأمريكية مفتوحة للجميع. هذا المشروع يعيد إنتاج طريقة فرز الإشارات: استخراج أزواج الدواء والعرض، إزالة التكرار، وحساب مؤشرات التناسب مع فواصل الثقة، ووضع النتائج في قائمة مراجعة. مناسب لليقظة الدوائية. الإشارة ليست سببية ولا معدل حدوث.
...
**الفكرة ببساطة:** وكالة الأدوية الأوروبية تنشر بيانات موقعها كاملة بصيغة منظمة تُحدّث مرتين يوميًا: الأدوية، الإجراءات، الوثائق، والنقص. هذا المشروع يراقب التغيرات ويبني سجل أحداث قابلًا للتدقيق. مناسب للشؤون التنظيمية الأوروبية والنقص. بيانات الموقع لا تمثل كل التنظيم الداخلي.
...
**الفكرة ببساطة:** خطابات التحذير الأمريكية للمصانع وثائق عامة تشرح ملاحظات الجودة والتصنيع. هذا المشروع يصنف موضوعاتها (سلامة البيانات، التحقق، التلوث، الثبات) بقواعد قابلة للتدقيق ومع عينة يراجعها إنسان. مناسب لوظائف الجودة والتصنيع. غياب خطاب لا يعني الامتثال، ولا يُبنى تقييم لشركة بعينها.
...
**الفكرة ببساطة:** كثير من التجارب المسجلة لا تنشر نتائجها في الوقت المتوقع. هذا المشروع يقيس وصفيًا زمن نشر النتائج حسب الراعي والمرحلة والحالة والدولة، بقواعد معلنة لما هو «مرشح للتأخر». مناسب لنزاهة البحث. لا يصدر حكمًا قانونيًا بعدم الامتثال.
...
**الفكرة ببساطة:** معايير أهلية التجارب مكتوبة نصًا، وتحويلها إلى قواعد قابلة للتنفيذ مهارة مطلوبة في الأبحاث السريرية. هذا المشروع يختار تجربة واحدة ويحول خمسة إلى عشرة معايير إلى قواعد تعمل على مرضى مصطنعين، ويقيس نسبة التأهل. مناسب للأبحاث السريرية. لا يقول شيئًا عن التوظيف الحقيقي للمرضى.
...
**الفكرة ببساطة:** كل تجربة لها رقم تسجيل، وكل منشور له معرف، لكن الربط بينهما غالبًا ناقص. هذا المشروع يربط التجارب بالمنشورات عبر ثلاث قواعد بيانات علمية عامة، ويميز الروابط المؤكدة من المرشحة من المفقودة. مناسب لمسار الأدلة والمراجعات المنهجية. غياب الرابط لا يعني أن التجربة لم تُنشر.
...
**الفكرة ببساطة:** شركات الأدوية تُخرج جداول السلامة من بيانات التجارب بصيغة معيارية. هذا المشروع يبني خطًا برمجيًا يعالج بيانات اختبار مفتوحة بهذه الصيغة وينتج جداول الأعراض الجانبية والتعرض والخصائص بشكل قابل لإعادة الإنتاج. مناسب لمسار البرمجة السريرية. البيانات تجريبية ولا تُنسب إلى دواء حقيقي.
...
**الفكرة ببساطة:** تسوية الأدوية عند انتقال المريض بين مستويات الرعاية مهمة صيدلانية أساسية. هذا المشروع يبني قائمة الأدوية النشطة من سجلات مصطنعة ويكشف التعارضات المحتملة (تكرار مادة، جرعة ناقصة، أمر قديم). مناسب للصيدلة السريرية. لا يقدم تفاعلات دوائية سريرية ولا قائمة مريض حقيقي.
...
**الفكرة ببساطة:** الانتقال بين أنظمة الترميز الطبية (تشخيصات، مصطلحات سريرية، أسماء أدوية، تصنيف علاجي) ليس استبدال نص؛ فالكود الواحد قد يقابل صفرًا أو عدة أكواد. هذا المشروع يبني مختبرًا يوضح ذلك ويقيّم جودة خرائط صغيرة عامة. مناسب لمسار الترميز والمعلوماتية. لا يعيد توزيع حزم مرخصة.
...
**الفكرة ببساطة:** الأبحاث على البيانات الواقعية تعتمد على نموذج بيانات موحد عالمي. هذا المشروع يحول سجلات مرضى مصطنعين إلى هذا النموذج ويقيس ما فُقد وما لم يُربط أثناء التحويل. مناسب لمسار المعلوماتية والبيانات الواقعية. الناتج ليس بيانات واقعية حقيقية.
...
**الفكرة ببساطة:** برنامج الدواء الحكومي الأمريكي ينشر بيانات الوصف والتكلفة حسب الجغرافيا والتخصص. هذا المشروع يستكشف التباين في وصف أدوية مختارة مع ضبط المقامات والقيم المحجوبة. مناسب لتحليل استخدام الدواء والتأمين. التباين ليس إفراطًا في الوصف.
...
**الفكرة ببساطة:** سوق التأمين الأمريكي ينشر ملفات عامة لخطط التأمين ومزاياها وروابط قوائم أدويتها. هذا المشروع يقارن عددًا محدودًا من الخطط ويُظهر اختلاف بنية البيانات وجودتها. مناسب لمسار التأمين والتغطية. لا يحدد أهلية فرد ولا «أفضل خطة».
...
**الفكرة ببساطة:** الحكومة الأمريكية تنشر أسبوعيًا متوسط تكلفة اقتناء الأدوية للصيدليات. هذا المشروع يراقب تغير هذه التكلفة للأدوية الجنيسة والتجارية عبر الزمن. مناسب لمسار التسعير. تكلفة الاقتناء ليست سعر بيع ولا تعويضًا ولا سعرًا صافيًا.
...
**الفكرة ببساطة:** تحليل فعالية التكلفة يقارن دواءين في تكلفتهما ونتائجهما الصحية عبر الزمن. هذا المشروع يبني نموذجًا تعليميًا شفافًا لحالة مرضية واحدة مع تحليل عدم اليقين وتقرير يتبع معيار الإبلاغ الدولي. مناسب للاقتصاد الصحي. لا يدّعي صلاحيته لقرار سعودي دون مدخلات محلية كافية.
...
**الفكرة ببساطة:** الأثر الميزاني يسأل: كم سيكلف إدخال دواء جديد جهة دافعة خلال سنوات قليلة؟ هذا المشروع يبني صندوق سيناريوهات لسياق سعودي بمدخلات موسومة (حقيقية من القوائم العامة أو مصطنعة). مناسب للاقتصاد الصحي والتأمين. ليس تقديرًا رسميًا لميزانية أي جهة.
...
**الفكرة ببساطة:** أي تغيير على دواء مسجل (مصنع جديد، مواصفة جديدة، تغليف جديد) يحتاج ملفًا بوثائق محددة يذكرها دليل الهيئة حرفيًا. هذا المشروع يحول الدليل إلى قائمة تحقق تفاعلية: تختار نوع التغيير فتظهر الوثائق المطلوبة بمرجع الصفحة، وتحصل على قائمة نواقص. مناسب للشؤون التنظيمية المحلية، ومن أنسب المشاريع لغير المبرمج. لا يتوقع زمن المراجعة ولا احتمال القبول.
...
**الفكرة ببساطة:** منظمة الصحة العالمية تصنف المضادات الحيوية إلى ثلاث مجموعات (متاح، مراقَب، احتياطي) ومجموعة رابعة «غير موصى بها» للتوليفات الثابتة. هذا المشروع يربط المضادات المسجلة في السعودية بهذا التصنيف ويُظهر توزيعها، وأي مضادات الاحتياطي لا منتج مسجل لها، وأي التوليفات غير الموصى بها موجودة في السجل. مناسب لترشيد المضادات والصيدلة السريرية. التسجيل ليس استهلاكًا، والأداة لا تحكم على أي منتج.
...
**الفكرة ببساطة:** أمريكا وأوروبا والسعودية تنشر قوائم نقص الأدوية علنًا، كلٌّ بصيغته. هذا المشروع يجمع القوائم الثلاث ويُظهر أي المواد الفعالة تظهر في أكثر من قائمة، وأي المواد في نقص أجنبي لها منتجات مسجلة محليًا. مناسب لسلاسل الإمداد وصيدلة المستشفيات، ومناسب لغير المبرمج. تقاطع وصفي؛ ليس إنذارًا مبكرًا ولا توقعًا لنقص محلي.
...
**الفكرة ببساطة:** حين ترفض إدارة الغذاء والدواء الأمريكية طلب تسجيل، ترسل «خطاب رد كامل» يشرح الأسباب. الإدارة نشرت مئات هذه الخطابات بنصها الكامل. هذا المشروع يصنف أسباب الرفض (تصنيع، سريري، سلامة، تسمية، تفتيش، إحصاء) بقواعد قابلة للتدقيق مع اقتباس المقطع. مناسب للشؤون التنظيمية وفهم لماذا تُرفض الملفات. لا يقيّم شركة أو موظفًا.
...
**الفكرة ببساطة:** كل سحب دواء من السوق الأمريكي يُسجل علنًا مع سببه وتصنيف خطورته. هذا المشروع يصنف أسباب السحب (تلوث، انحراف مواصفات، تغليف، ثبات) ويعرض توزيعها حسب الخطورة والسنة والشكل الصيدلاني. مناسب لوظائف الجودة والتصنيع، ومناسب لغير المبرمج. لا يرتب الشركات ولا يستنتج أثرًا على السوق السعودي.
...
**الفكرة ببساطة:** الصيدلة الجينية تدرس كيف تؤثر جينات المريض في استجابته للدواء، وهناك جهة دولية تنشر إرشادات لأزواج «جين–دواء» بمستوى دليل لكل زوج. هذا المشروع يُظهر أي المواد الفعالة المسجلة في السعودية لها إرشادات منشورة وبأي مستوى. مناسب للصيدلة السريرية والطب الدقيق. أداة تغطية معرفية، ليست توصية بفحص أو جرعة.
...
**الفكرة ببساطة:** الدواء الواحد يُكتب بعشر طرق: اسم تجاري، اسم علمي، ملح مختلف، خطأ إملائي، اسم عربي منقول. هذا المشروع يبني خدمة صغيرة تحل أي اسم إلى هوية معيارية بدرجة ثقة وبدائل، ولا تطابق صامتًا عند الشك. مناسب لمسار البيانات والتكامل، ويحتاج قدرة برمجية. حل الاسم ليس تكافؤًا علاجيًا.
...
**الفكرة ببساطة:** منظمة الصحة العالمية «تؤهل مسبقًا» منتجات دوائية محددة (لعلاج الإيدز والسل والملاريا وغيرها) لتشتريها المنظمات الدولية بثقة. هذا المشروع يقارن هذه المنتجات بالمواد المسجلة في السعودية: ما المؤهل مسبقًا وله منتج محلي، وما ليس له. مناسب لمسار الصحة العالمية والمشتريات، وسهل لغير المبرمج. التأهيل المسبق ليس تسجيلًا سعوديًا.
...
**الفكرة ببساطة:** من ملف الأدوية المسجلة العام يمكن فهم بنية السوق: لكل مادة فعالة كم شركة وكم تركيزًا وكم شكلًا وعبوة، وأي الفئات العلاجية يسيطر عليها مصنّع واحد. هذا المشروع يبني خريطة تفاعلية لذلك مع مؤشر تركّز يُسمى بصدق «بديل هيكلي بعدد المنتجات». مناسب لوصول السوق والتخطيط والإمداد. ليس تحليل حصص سوقية، والتسجيل ليس توافرًا.
...
## Before sending any specification to the agent
